...
[assembly: WebActivator.PreApplicationStartMethod(typeof(PizzaMvcWebApi.App_Start.NinjectWebCommon), "Start")]
[assembly: WebActivator.ApplicationShutdownMethodAttribute(typeof(PizzaMvcWebApi.App_Start.NinjectWebCommon), "Stop")]

namespace PizzaMvcWebApi.App_Start
{
    using System;
    using System.Web;
    ...
    public static class NinjectWebCommon 
    {
        ...
        public static void Start() 
        {
            ...
            GlobalConfiguration.Configuration.ServiceResolver
              .SetResolver(System.Web.Mvc.DependencyResolver.Current.ToServiceResolver());
        }
